...
>>>>>>> c5ba78b35286f4f591bccd3616bccd17de02bfa0
...
def get_picked_item(item_code, batch_no, company, from_date, to_date, bal_qty, total_picked_qty, total_remaining_qty, lot_no):
	...
	picked_item = frappe.db.sql(f"""
		SELECT pli.date, pli.customer, pli.sales_order, pli.sales_order_item, pl.name as pick_list, pli.name as pick_list_item, pli.item_code, pli.item_name, pli.qty as picked_qty, pli.delivered_qty, (pli.qty - pli.delivered_qty) as remaining_qty FROM `tabPick List Item` as pli JOIN `tabPick List` as pl on pli.parent = pl.name 
